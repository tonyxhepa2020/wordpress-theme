...
$aecond_args = array(
    ...
    'orderby'        => 'date',
    'post_status' => 'publish',
    'cat'         => get_theme_mod( 'ju_second_section_posts' ),
);
// the query
$second_section = new WP_Query( $aecond_args ); ?>
        ...
        <div class="technology_catrarea">
            <div class="single_category">
                <h2>
                    ...
                    <a class="title_text" href="#"><?php echo get_theme_mod('ju_second_section_category_title'); ?>
                    </a>
                </h2>                <!-- the loop -->
